...
Rails.application.routes.draw do
  ...
  post 'by_building', to: 'floors#by_building'
  post 'by_floor', to: 'spaces#by_floor'
  ...
  post 'buildings_by_ids', to: 'buildings#buildings_by_ids'
  post 'floors_by_ids', to: 'floors#floors_by_ids'
  post 'spaces_by_ids', to: 'spaces#spaces_by_ids'
  get 'assignments_by_user', to: 'assignments#assignments_by_user'
end
