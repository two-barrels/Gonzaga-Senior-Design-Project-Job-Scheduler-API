namespace :db do
    ...
    task populate_spaces_full_table: :environment do
      ...
      test_space_2 = { spaces_name: 'Conference Room 04', floor_id: 2, max_occupancy: 9, description: "Testing room nine" }
      test_space_3 = { spaces_name: 'Conference Room 05', floor_id: 1, max_occupancy: 15, description: "Testing room diff floor"  }
