...
namespace :db do
  ...
  task populate_spaces_table: :environment do
    ...
    space_two = { spaces_name: 'Conference Room 03', floor_id: 2, max_occupancy: 20,
                  description: 'another small conference room' }
    space_three = { spaces_name: 'Conference Room 04', floor_id: 1, max_occupancy: 8,
                    description: 'tiny conference room' }
